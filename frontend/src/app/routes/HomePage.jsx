...
const CinematicMarketHero = lazy(() => import('@/components/ui/CinematicMarketHero'));
const CategoryCarousel = lazy(() => import('@/features/products/components/CategoryCarousel'));
const ProductRail = lazy(() => import('@/features/products/components/ProductRail'));
