...
const Navbar = () => {
  // useCartState: granular subscription to cart state only
                ...
                <div className="relative hidden sm:block" data-dropdown>
                  ...
                  {userOpen && (
                    ...
                    >
                      ...
                      <div className="p-3">
                        {isSeller && (
                          <Link to="/seller" onClick={() => setUserOpen(false)} className={menuLink}>
                            <LayoutDashboard className="h-4 w-4 text-amber-600 dark:text-amber-200" />
                            Seller Dashboard
                          </Link>
                        )}
                        <Link to="/profile" onClick={() => setUserOpen(false)} className={menuLink}>
                          <User className="h-4 w-4" /> Profile
                        </Link>
                        <button
                          onClick={handleLogout}
                          className="flex w-full items-center gap-3 rounded-2xl px-4 py-2.5 text-left text-sm font-bold text-red-500 transition-colors hover:bg-red-500/5"
                        >
